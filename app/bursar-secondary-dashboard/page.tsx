        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-token-micro font-black text-brand-primary/40 uppercase tracking-[0.4em]">SECONDARY BURSARY</span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-3 bg-white rounded-3xl border border-brand-primary/8 shadow-sm p-6 md:p-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-token-micro font-black text-brand-primary/40 uppercase tracking-widest">Secondary Campus</span>
            </div>
            {requests.length === 0 ? (
